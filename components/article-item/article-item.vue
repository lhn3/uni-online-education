<template>
	<view class="article-item" @click="navTo(`/pages/tab-article/article-details?id=${item.id}`)">
		...
		<view class="article-info">
			...
			<text> · {{ this.$utils.dateFormat(item.updateDate) }}</text>
			<text> · {{formatCount(item.thumhup)}} 赞</text>
		</view>
	</view>
</template>
