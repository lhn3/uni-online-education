...
try {
  components = {
    searchInput: function() {
      return __webpack_require__.e(/*! import() | components/search-input/search-input */ "components/search-input/search-input").then(__webpack_require__.bind(null, /*! @/components/search-input/search-input.vue */ 48))
    },
    mySwiper: function() {
      return __webpack_require__.e(/*! import() | components/my-swiper/my-swiper */ "components/my-swiper/my-swiper").then(__webpack_require__.bind(null, /*! @/components/my-swiper/my-swiper.vue */ 55))
    }
  }
} catch (e) {
  if (
...
var _courseData = _interopRequireDefault(__webpack_require__(/*! @/mock/courseData.js */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var categoryBox = function categoryBox() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/category-box */ "pages/index/cpns/category-box").then((function () {return resolve(__webpack_require__(/*! ./cpns/category-box.vue */ 62));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var swiperCourse = function swiperCourse() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/swiper-course */ "pages/index/cpns/swiper-course").then((function () {return resolve(__webpack_require__(/*! ./cpns/swiper-course.vue */ 69));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var scrollCourse = function scrollCourse() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/scroll-course */ "pages/index/cpns/scroll-course").then((function () {return resolve(__webpack_require__(/*! ./cpns/scroll-course.vue */ 74));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var payCourse = function payCourse() {__webpack_require__.e(/*! require.ensure | pages/index/cpns/pay-course */ "pages/index/cpns/pay-course").then((function () {return resolve(__webpack_require__(/*! ./cpns/pay-course.vue */ 81));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { 'category-box': categoryBox, 'swiper-course': swiperCourse, 'scroll-course': scrollCourse, 'pay-course': payCourse }, setup: function setup() {var _getCurrentInstance = (0, _vue.getCurrentInstance)(),proxy = _getCurrentInstance.proxy; // APP端搜索提示内容
